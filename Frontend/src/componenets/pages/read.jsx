    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-md-3">
          <a href="/inbox" className="btn btn-primary btn-block mb-3">Back to Inbox</a>
          <div className="card">
          ...
          <div className="card card-primary card-outline">
            ...
            <div className="card-body p-0">
              <div className="mailbox-read-info">
                ...
                <h6>From: support@muawin.com
                  <span className="mailbox-read-time float-right">05 Jun. 2023 04:30 PM</span></h6>
              </div>
              {/* /.mailbox-read-info */}
